...
def create_prompts_page(state):
    ...
    def show_prompt_dialog(pid):
        ...
        category_field = ft.Dropdown(
            label='分类', value=p.get('category', '其他'),
            options=[ft.dropdown.Option(c) for c in ['编程', '写作', '分析', '绘画', '用户', '其他']], expand=True,
        )
        ...
        def save_prompt(e):
            ...
            new_prompt = {
                ...
                'category': category_field.value or '用户', 'prompt_type': 'user', 'is_builtin': False,
            }
